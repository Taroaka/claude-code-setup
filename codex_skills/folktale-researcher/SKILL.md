...
description: 国/地域を指定して民話・神話・伝承の「制作向けネタ」を調べ、候補リスト→1本深掘り（Story-first + scene_plan）まで出す。ToCの `workflow/research-template.yaml` に沿った骨格出力や、文化配慮/権利注意/出典当たりの観点整理を行う時に使用。
---
